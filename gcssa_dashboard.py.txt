...
def main():
    ...
    if selected_status == 'Pending SR/Incident':
        ...
        selected_sr_incident = st.selectbox("Select SR/Incident to View Details", grouped_cases['SR/Incident Number'].unique())

        if selected_sr_incident:
            st.subheader(f"🧾 Detailed Cases for {selected_sr_incident}")
